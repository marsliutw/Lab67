...
class MainActivity : AppCompatActivity() {
    ...
    inner class MyAdapter(private val data: Array<Data?>, private val view: Int) :
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            val convert = layoutInflater.inflate(view, parent, false)
            val name = convert.findViewById<TextView>(R.id.name)
            name.setText(data[position]!!.name)
            val imageView = convert.findViewById<ImageView>(R.id.imageView)
